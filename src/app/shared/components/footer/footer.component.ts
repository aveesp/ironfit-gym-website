          ...
          <div class="lg:col-span-1">
            ...
            <div class="flex gap-4">
              @for (social of socials; track social.name) {
                <a [href]="social.href" class="w-10 h-10 rounded-lg bg-dark-600 hover:bg-primary flex items-center justify-center transition-colors duration-300" [innerHTML]="social.icon"></a>
              }
            </div>
          </div>
